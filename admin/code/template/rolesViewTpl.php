...
?>
          <tr <?=$displaynone;?> >
            <td width="1%">
            <input disabled name="mod_uid[<?=$row["mod_uid"]?>]" type="checkbox" id="mod_uid[<?=$row["mod_uid"]?>]" <?=$OnOff3?> value="<?=$row["mod_uid"]?>" onclick="checkAll('mod_uid[<?=$row["mod_uid"]?>]')" />
			</td>
        ...
        <!--<td>
            ...
            ?>
             <div style="display:none">
                <input disabled name="mod_uid[<?=$row["mod_uid"]?>][]" id="mod_uid[<?=$row["mod_uid"]?>][]" type="checkbox"  <?=$OnOff4?> value="<?=$row2["mod_uid"]?>"  />
		<?=$row2["mod_name"]?>
            </div>
             <?php
                    }
                    if(strlen($uidModuleAcces)>0)
                        ...
                        if($cantidadOp>0){                          
	                     ...
	                     $db4->query($sSQL);
                                ...
                                ?>
                                <td width="1%"><input disabled name="mod_uid[<?=$row["mod_uid"]?>][<?=$options["mop_mod_uid"]?>][]" <?=$checked?> type="checkbox" value="<?=$options["mop_uid"]?>" <?=$lblStatus?> /></td>
