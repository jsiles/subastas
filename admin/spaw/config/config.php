...
// Lenguaje del Tiny (es=español, en = ingles) 
SpawConfig::setStaticConfigItem('default_lang','es');
...
// height 
SpawConfig::setStaticConfigItem('default_height','400px');
...
// directories
global $domain,$rootsystem;
SpawConfig::setStaticConfigItem(
  'PG_SPAWFM_DIRECTORIES',
  array(
    array(
      'dir'     => $domain.'/uploadswys/flash/',
    ...
    array(
      'dir'     => $domain.'/uploadswys/files/',
      'fsdir'   => $rootsystem.'/uploadswys/files/', // optional absolute physical filesystem path
      'caption' => 'Files', 
      'params'  => array(
