...
<tr><td valign="top"><?php include_once("skin/header.php");?>
  ...
  <tr>
    <td valign="top" id="content"><?php include_once("code/template/subastasRavViewTpl.php"); ?></td>
  </tr>
<tr><td>
