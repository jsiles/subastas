...
admin::initialize('client','permitUpd',false); 
?>
...
<script language="javascript" type="text/javascript" src="js/permit.js"></script>
</head>
<body>
...
<tr><td valign="top"><? include_once("skin/header.php");?>
  ...
  <tr>
    <td valign="top" id="content"><? include_once("code/template/permitEditTpl.php"); ?></td>
  </tr>
<tr><td>
