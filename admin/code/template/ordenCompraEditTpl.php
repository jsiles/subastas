  ...
  <tr>
	...
	<tr>
            <td width="5%" >Nro de Solicitud:</td>
             <td width="20%"><input name="orc_sol_uid" id="orc_sol_uid" value="<?=$oc["orc_sol_uid"]?>" class="input">
        ...
        <tr>
            <td width="5%" >Unidad Solicitante:</td>
             <td width="40%">
                                 <input name="orc_uid" id="orc_uid" value="<?=$orc_uid?>" type="hidden" />
        ...
        <tr>
            <td width="5%" >Monto:</td>
            <td width="20%" ><input name="orc_monto" id="orc_monto" type="text" value="<?=$oc["orc_monto"]?>" class="input">
                <?php 
        ...
        <tr>
            ...
            <td width="20%" valign="top">
				...
				<input name="orc_fecha" type="text" class="input"  id="orc_fecha" value="<?=$oc["orc_fecha"]?>" size="15" >
        ...
        <tr>
            <td width="5%" >Hora:</td>
            <td width="20%" ><input name="orc_hora" type="text" value="<?=substr($oc["orc_hora"],0,5)?>" class="input">
        ...
        <tr>
            ...
            <td width="20%" ><input name="orc_aprobado" type="text" value="<?=$oc["orc_aprobado"]?>" class="input">
        ...
        <tr>
			...
			<tr>
				...
				<span class="pipe">|</span> <a href="#" onclick="removeImg(<?=$oc["orc_uid"]?>);return false;" title="<?=admin::labels('del')?>" class="small3"><?=admin::labels('del')?></a>				
                                </td>
			</tr>
			<tr>
				<td height="24">
