...
//nImg.src = 'image/drag_drop_poof.gif';
...
window.onload = function(){
 ...
 if(Demos[0]){
 CreateDragContainer(document.getElementById('divitem'));
 //CreateDragContainer(document.getElementById('subcontenido'));
  //CreateDragContainer(document.getElementById('DragContainer7'));
 //CreateDragContainer(document.getElementById('Item3'));
 //CreateDragContainer(document.getElementById('collapser'));
 }
/* if(Demos[4]){
